...
<div>
    ...
    <strong>You account has been created. However, before you can use it you need to confirm your email address first by
        clicking the
        <a href="{!!URL::route('user.email-confirmation', ['token' => $body['token'], 'email' => $body['email'] ] )!!}">Following
            link</a></strong>
    <br/>
